...
%post
	...
	perl $HOME/src/ensembl-vep/INSTALL.pl -a acf -s Saccharomyces_cerevisiae -y R64-1-1 -c ${SINGULARITY_ROOTFS}/.vep
	perl $HOME/src/ensembl-vep/INSTALL.pl -a acf -s homo_sapiens -y GRCh37 -c ${SINGULARITY_ROOTFS}/.vep
